...
#define DOCTEST_ASSERT_IMPLEMENT_2(assert_type, ...)                                                                                                                                \
    ...
    DOCTEST_WRAP_IN_TRY(                                                                                                                                                            \
        DOCTEST_RB.setResult(doctest::detail::ExpressionDecomposer(doctest::assertType::assert_type) << __VA_ARGS__)) /* NOLINTNEXTLINE(clang-analyzer-cplusplus.NewDeleteLeaks) */ \
...
#define DOCTEST_ASSERT_IMPLEMENT_1(assert_type, ...)                              \
    ...
    doctest::detail::decomp_assert(                                               \
        ...
        __LINE__,                                                                 \
        #__VA_ARGS__,                                                             \
        doctest::detail::ExpressionDecomposer(doctest::assertType::assert_type) << __VA_ARGS__) DOCTEST_CLANG_SUPPRESS_WARNING_POP
...
namespace doctest
{
    namespace detail
    {
        ...
        TestCase::TestCase(
            funcType test, const char *file, unsigned line, const TestSuite &test_suite, const String &type, int template_id) noexcept
        {
            m_file = file;
            m_line = line;
